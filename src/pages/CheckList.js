// still room for performance optimizations, but as this simple script does not require machine learning, we may put off the optimization stuff
...
function gotYou(data) {
    ...
    try {
        ...
        console.debug("Input List: '" + data.iList + "' is not a valid wechat check-in list. Will be separated by line");
    }
