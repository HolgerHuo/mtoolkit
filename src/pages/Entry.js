...
const tools = [{ name: '微信接龙考勤', path: '/check-list', descriptionText: '一个可以帮你找出谁没有接龙、自动识别出接龙中的选项的小工具', backgroundImg: checkListBackground, imgAlt: 'wechat check-in helper screenshot' }];
